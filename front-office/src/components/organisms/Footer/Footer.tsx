...
import { contactData } from '@/configs/siteSettings';
      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            ...
            <div className="max-w-sm mt-5 ml-2">
              <Typography variant="h3">{contactData.addressName}</Typography>
              <Typography variant="h4" weight="semibold" color="gray" marginClassName="mt-3">
                {contactData.fabrikaAddress}
              </Typography>
            </div>
          </div>
        ...
        <div className="flex md:flex-row flex-col gap-5 items-center sm:justify-between">
          ...
          <div className="flex gap-10 items-center justify-center">
            <LanguageSwitcher />
            <Link target="_blank" href={contactData.instagramLink} className="text-gray-500 hover:cursor-pointer hover:text-gray-900">
