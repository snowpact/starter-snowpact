...
export const SubNavbar: React.FC<Props> = ({ items }) => {
  return (
    <div className="hidden md:flex animate-fade-down animate-duration-300 absolute top-20 left-0 right-0 border-gray-200 shadow-md bg-gray-50 md:bg-white border-y z-50">
      <div className="max-w-screen-xl px-4 py-5 gap-10  mx-auto justify-items-center text-gray-900 md:px-6">
