...
export class Setup1724060323931 implements MigrationInterface {
  name = 'Setup1724060323931';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
            ...
            ADD CONSTRAINT "fk__user_token-user_id__user-id__a6427bb5" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
  }
