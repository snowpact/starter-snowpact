...
import { TokenRepositoryInterface } from '@/infrastructure/repositories/tokenRepository/token.repository.interface';
...
import { TokenInterface } from './token/token.interface';
